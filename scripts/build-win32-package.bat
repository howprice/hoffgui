...
"C:\Program Files\Microsoft Visual Studio\2022\Community\Common7\IDE\CommonExtensions\Microsoft\CMake\CMake\bin\cmake.exe" -S. -B%BUILD_DIR% -G "Visual Studio 17 2022" -T host=x64 -A win32 || EXIT /B 1
