-- From https://github.com/kracejic/cleanCppProject with thanks
-- AppleScript to generate .DS_Store file for CPack DragNDrop (dmg) generator
	...
	tell application "Finder"
		tell disk diskImage
			...
			tell container window
				...
				set position of item "hoffgui.app" to {230, 115}
